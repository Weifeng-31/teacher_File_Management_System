  ...
  FsTab = function (){
  	this.config = {
  		topMenuFilter:"fsTopMenu",//头部菜单
			...
			tabFilter:"fsTab",//导航栏
		rightMenuFilter:"rightMenu"//右边菜单
		}
	};
   ...
   */
	...
	FsTab.prototype.menuSelectCss = function(layId){
		if(!$.isEmpty(layId)){
			...
			$('#rightMenu .layui-this').removeClass("layui-this");//清除样式
			var dom =$('#fsLeftMenu .layui-nav-child>dd[lay-id="'+ layId +'"],#fsLeftMenu>li[lay-id="'+ layId +'"],#rightMenu .layui-nav-child>dd[lay-id="'+ layId +'"]');
