...
<div class="layui-fluid">	<form class="layui-form" id="edit_form" loadUrl="">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline">
			<input type="text" name="userId" id="userId" placeholder="请输入工号" autocomplete="off"  required="" lay-verType="tips"  class="layui-input layui-disabled" disabled="disabled"/>
		</div>
	...
	<div class="layui-form-item" style="text-align: center;">
		<button class="layui-btn fsEdit" lay-submit="" lay-filter="edit" url="/saveSalaryAction">新增</button>
