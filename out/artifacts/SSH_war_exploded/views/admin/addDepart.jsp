	...
	<input type="hidden" name="id"/>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="departmentId" required="" lay-verType="tips" lay-verify="required" placeholder="请输入学院ID" autocomplete="off"  class="layui-input" />
			</div>
			<label class="layui-form-label">学院名称</label>
			<div class="layui-input-inline">
				<input type="text" name="departmentName" required="" lay-verType="tips" lay-verify="required" placeholder="请输入学院名称" autocomplete="off"   class="layui-input"/>
			</div>
		</div>
