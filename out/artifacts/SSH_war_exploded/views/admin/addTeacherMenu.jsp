	...
	<input type="hidden" name="id"/>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="checkbox" name="roleName" title="普通教师" value="3" class="layui-input"  lay-verify="required" >
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">角色ID</label>
			<div class="layui-input-inline">
				<input type="text" name="roleId" required="" lay-verType="tips" lay-verify="required"  autocomplete="off" value="3" class="layui-input layui-disabled" disabled="disabled"/>
			</div>
