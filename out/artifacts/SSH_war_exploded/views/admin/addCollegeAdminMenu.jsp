	...
	<input type="hidden" name="id" />
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="checkbox" name="roleName" title="院系管理员" value="2" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">角色ID</label>
			<div class="layui-input-inline">
				<input type="text" name="roleId" required="" lay-verType="tips" lay-verify="required"  autocomplete="off" value="2" class="layui-input layui-disabled" disabled="disabled"/>
			</div>
