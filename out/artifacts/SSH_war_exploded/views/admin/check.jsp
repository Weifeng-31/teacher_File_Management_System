	...
	<input type="hidden" name="id"/>
	  <div class="layui-form-item">
			...
			<div class="layui-input-inline">
			  <input type="text" name="userId" required="" lay-verType="tips" lay-verify="required" placeholder="请输入教师工号" autocomplete="off" class="layui-input layui-disabled" disabled="disabled"/>
			</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="age" required="" lay-verType="tips" lay-verify="required" placeholder="请输入专业" autocomplete="off" class="layui-input"/>
			</div>
			<label class="layui-form-label">籍贯</label>
			<div class="layui-input-inline">
				<input type="text" name="province" required="" lay-verType="tips" lay-verify="required" placeholder="请输入专业" autocomplete="off" class="layui-input"/>
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<label class="layui-form-label">籍贯</label>
			<div class="layui-input-inline">
				<input type="text" name="address" required="" lay-verType="tips" lay-verify="required" placeholder="请输入籍贯" autocomplete="off" class="layui-input"/>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">政治面貌</label>
			<div class="layui-input-inline">
				<select name="political" lay-verify="required" lay-verType="tips" class="fsSelect" dict="political" addNull="1">
				</select>
			</div>
			<label class="layui-form-label">出生日期</label>
			<div class="layui-input-inline">
				<input type="text" name="born"  lay-verify="required" lay-verType="tips" autocomplete="off" class="layui-input fsDate" dateType="datetime" />
			</div>
		</div>
		<div class="layui-form-item">
	  ...
	  <hr/>
		<div class="layui-form-item" style="text-align: center;">
			...
			<button class="layui-btn fsEdit" lay-submit="" lay-filter="edit" url="/editTeacherAction">编辑</button>
