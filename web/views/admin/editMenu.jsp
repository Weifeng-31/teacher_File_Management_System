	...
	<input type="hidden" name="id"/>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="checkbox" name="roleName" title="系统管理员" value="1" class="layui-input layui-disabled" disabled="disabled">
				<input type="checkbox" name="roleName" title="院系管理员" value="2" class="layui-input layui-disabled" disabled="disabled">
				<input type="checkbox" name="roleName" title="普通教师" value="3" class="layui-input layui-disabled" disabled="disabled">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">角色ID</label>
			<div class="layui-input-inline">
				<input type="text" name="roleId" required="" lay-verType="tips" lay-verify="required" placeholder="请输入角色ID" autocomplete="off" class="layui-input layui-disabled" disabled="disabled"/>
			</div>
			<label class="layui-form-label">菜单ID</label>
			<div class="layui-input-inline">
				<input type="text" name="menuId" required="" lay-verType="tips" lay-verify="required" placeholder="请输入菜单ID" autocomplete="off"  class="layui-input layui-disabled" disabled="disabled"/>
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="menuIcon"  lay-verType="tips" placeholder="请输入菜单图标" autocomplete="off" class="layui-input"/>
			</div>
