...
<div class="layui-fluid">
    <div class="layui-row layui-col-space1">
        ...
        <div class="layui-col-md3">
            <button class="layui-btn layui-btn-normal" function="top" topUrl="views/admin/addTeacher.jsp" topMode="add" topWidth="800px"
                    topHeight="680px" topTitle="新增管理员信息">
        ...
        <div class="layui-col-md12">
            <table id="fsDatagrid" lay-filter="fsDatagrid" class="fsDatagrid" isLoad="1" url="/queryMemberAction?roleId=2"
            ...
            <script type="text/html" id="barDemo">
                <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="top" topUrl="views/admin/check.jsp"
                   topMode="readonly" topWidth="800px" topHeight="620px" topTitle="查看详细信息" inputs="id:">查看</a>
                <a class="layui-btn layui-btn-xs" lay-event="top" topUrl="views/admin/edit.jsp" topMode="edit"
                   topWidth="800px" topHeight="620px" topTitle="编辑管理员信息" inputs="id:,userId:,">编辑</a>
