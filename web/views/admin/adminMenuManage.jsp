...
<div class="layui-fluid">
    <div class="layui-row layui-col-space1">
        <blockquote class="layui-elem-quote">
            <span style="color: #FF5722;">系统管理员您好！</span>此页面可以新增、编辑和删除系统管理员的菜单界面，其中父菜单ID为0表示最上方的菜单根目录，请勿修改。修改后重新登录生效！
        </blockquote>

        <div class="layui-col-md3">
            <button class="layui-btn layui-btn-normal" function="top" topUrl="views/admin/addAdminMenu.jsp" topMode="add" topWidth="800px"
                    topHeight="380px" topTitle="新增系统管理员菜单">
        ...
        <div class="layui-col-md12">
            <table id="fsDatagrid" lay-filter="fsDatagrid" class="fsDatagrid" isLoad="1" url="/queryAdminMenu"
